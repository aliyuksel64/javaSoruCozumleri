...
public class C2_Methods {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Günlük kazançlar Listesi: " + gunlukKazanclar);

        System.out.println("Yapmak istediğiniz işlemi seçin: \n" +
                "Haftalık Ortalama için: 1'e basın.\n" +
                "Haftalık ortalama üstünde kazanılan günler için: 2'ye basın.\n" +
                "Haftalık ortalama altında kazanılan günler için: 3'e basın...");
